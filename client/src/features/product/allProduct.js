        ...
        {sortedProducts.map((product) => (
          <Grid item xs={12} sm={6} md={4} lg={3} key={product.id}>
            <Card sx={{ width: '100%', boxShadow: 'lg' }}>
              ...
              <CardContent>
                <Typography level="body-xs" sx={{ fontSize: '1.25rem', fontWeight: 'bold' }}>{product.name}</Typography>
                <Typography
                  level="title-lg"
                  sx={{ mt: 1, fontWeight: 'xl' }}
                  endDecorator={<>{product.isOnSale ?
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'center', gap: 4 }}>
                    <Button
                      ...
                      sx={{
                        ...
                        color: 'white',
                        '&:hover': {
                          backgroundColor: '#cc2828', // צבע כהה יותר במצב hover
                        },
                      }}
                    >
                      Update
                ...
                {currentUser?.id !== 0 && (
                  <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 4 }}>
                    ...
                    <TextField
                      ...
                      sx={{ width: '80px' }}
                      placeholder="Amount"
                      onChange={(e) => setAddtocard1((prevState) => ({
                        ...prevState,
